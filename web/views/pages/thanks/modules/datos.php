...
<div class="d-flex p-3">
  ...
  <div class="align-self-center pl-3">
    <p class="m-0">Código del pedido - <strong><?= $_GET['ref'] ?></strong></p>
    <h4>¡Gracias, <?= $user->name_user ?>!</h4>
  </div>
</div>
...
<div class="mx-2 mt-3 p-2 rounded border bg-white">
  ...
  <div class="row row-cols-1 row-cols-sm-2 px-2">
    <div class="col my-3">
      ...
      <p class="small m-0 p-0"><?= $user->email_user ?></p>
      <p class="small m-0 p-0 mt-3"><strong>Dirección de envío</strong></p>
      <p class="small m-0 p-0"><?= $user->name_user ?></p>
      <p class="small m-0 p-0"><?= $user->address_user ?></p>
      <p class="small m-0 p-0"><?= $user->municipality_user ?></p>
      <p class="small m-0 p-0"><?= $user->zip_code_user ?>, <?= $user->state_user ?></p>
      <p class="small m-0 p-0"><?= $user->phone_user ?></p>
    </div>
