<div class="content-wrapper" style="min-height: 1504.06px;">
  ...
  <div class="content-header">
    <div class="container">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"> <small>Categorías</small></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container">
      ...
      <div class="card">
        ...
        <div class="card-header">
          ...
          <h3 class="card-title">
            <a href="/admin/categorias/gestion" class="btn bg-default templateColor py-2 px-3 btn-sm rounded-pill">Agregar Categoría</a>
          </h3>
