  ...
  <div class="container">
    <div class="card">
      <form method="post" class="needs-validation" novalidate enctype="multipart/form-data">
        <?php if (!empty($banner)): ?>
          <input type="hidden" name="idBanner" value="<?= base64_encode($banner->id_banner) ?>">
        <?php endif ?>
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-6 text-center text-lg-left">
                <h4 class="mt-3"><?= (!empty($banner)) ? 'Editar' : 'Agregar' ?> Banner</h4>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group pb-3 text-center">
                    ...
                    <label for="background_banner">
                      <?php if (!empty($banner)): ?>
                        <input type="hidden" value="<?= $banner->background_banner ?>" name="old_background_banner">
                        <img src="/views/assets/img/banner/<?= $banner->id_banner ?>/<?= $banner->background_banner ?>" class="img-fluid changeBackground">
                      <?php else: ?>
                  ...
                  <div class="form-group pb-3 locationCategory" <?php if (!empty($banner) && $banner->location_banner == "CATEGORÍA"): ?> style="display:block" <?php else: ?> style="display:none" <?php endif ?>>
                    ...
                    <select
                      ...
                      <?php foreach ($categories as $key => $value): ?>
                        <option value="<?= $value->id_category ?>" <?php if (!empty($banner) && $banner->id_category_banner == $value->id_category): ?> selected <?php endif ?>><?php echo $value->name_category ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>

                  <!-- ------------------------ SELECCIONDE SUBCATEGORIA ------------------------ -->
                  <div class="form-group pb-3 locationSubcategory" <?php if (!empty($banner) && $banner->location_banner == "SUBCATEGORÍA"): ?> style="display:block" <?php else: ?> style="display:none" <?php endif ?>>
                    ...
                    <select
                      ...
                      <?php foreach ($subcategories as $key => $value): ?>
                        <option value="<?= $value->id_subcategory ?>" <?php if (!empty($banner) && $banner->id_subcategory_banner == $value->id_subcategory): ?> selected <?php endif ?>><?php echo $value->name_subcategory ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input
                      ...
                      value="<?php if (!empty($banner)): ?><?= $banner->text_banner ?><?php endif ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input
                      ...
                      value="<?php if (!empty($banner)): ?><?= $banner->discount_banner ?><?php endif ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input
                      ...
                      class="form-control"
                      name="end_banner"
                      value="<?php if (!empty($banner)): ?><?= $banner->end_banner ?><?php endif ?>">
