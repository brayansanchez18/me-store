...
if (isset($_GET['from']) && isset($_GET['untill'])) {
  ...
  /* ------------ CALCULAR DIFERENCIA DE DIAS CON DATE RANGE PICKER ----------- */
  ...
  <div class="card mt-1 mb-4">
    <div class="card-header">
      ...
      <div class="card-tools mt-1">
        <span class="small">Rango actual: <?php if (isset($_GET["from"]) && isset($_GET["untill"])) {
...
<script>
  ...
  $('.daterange').daterangepicker({
    ...
    <?php if (isset($diff1) && isset($diff2)): ?>
      ...
      endDate: moment().subtract(<?php if ($diff2->invert > 0) {
                                    echo -$diff2->days;
                                  } else {
                                    echo $diff2->days;
                                  } ?>, 'days'),
