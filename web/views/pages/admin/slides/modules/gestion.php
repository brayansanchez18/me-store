  ...
  <div class="container">
    <div class="card">
      <form method="post" class="needs-validation" novalidate enctype="multipart/form-data">
        ...
        <?php if (!empty($slide)): ?>
          <input type="hidden" name="idSlide" value="<?= base64_encode($slide->id_slide) ?>">
        <?php endif ?>
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-6 text-center text-lg-left">
                <h4 class="mt-3"><?= (!empty($slide)) ? 'Editar' : 'Agregar' ?> Slide</h4>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group pb-3 text-center">
                    ...
                    <label for="background_slide">
                      ...
                      <?php if (!empty($slide)): ?>
                        <input type="hidden" value="<?= $slide->background_slide ?>" name="old_background_slide">
                        <img src="/views/assets/img/slide/<?= $slide->id_slide ?>/<?= $slide->background_slide ?>" class="img-fluid changeBackground">
                      <?php else: ?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group pb-3 text-center">
                    ...
                    <label for="img_png_slide">
                      ...
                      <?php if (!empty($slide)): ?>
                        <input type="hidden" value="<?= $slide->img_png_slide ?>" name="old_img_png_slide">
                        <img src="/views/assets/img/slide/<?= $slide->id_slide ?>/<?= $slide->img_png_slide ?>" class="img-fluid changeImgPng">
                      <?php else: ?>
                  ...
                  <div class="form-group">
                    ...
                    <input
                      ...
                      value="<?= (!empty($slide)) ? $slide->coord_img_slide : '' ?>">
