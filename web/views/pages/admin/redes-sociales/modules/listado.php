          ...
          <tbody>
            ...
            <?php foreach ($socials as $key => $value): ?>
              <tr>
                ...
                <td>
                  <a
                    href="<?= $value->url_social ?>"
                    target="_blank">
                    <?= $value->url_social ?> <i class="fas fa-external-link-alt ml-1"></i>
                  </a>
                </td>

                <td>
                  <span
                    class="badge badge-light border rounded-pill text-white py-2 px-3"
                    style="background:<?= $topColor->background ?>">
                ...
                <td>
                  <h3
                    class="border <?= $value->color_social ?> rounded p-0 m-0 text-center"
                    style="width:31px; height:31px">
                    <i class="fas fa-square p-0"></i>
                  </h3>
                </td>
                ...
                <td>
                  <div class="btn-group">
                    <button
                      href=""
                      class="btn bg-warning border-0 rounded-pill mr-2 btn-sm px-3 modalEditSocial"
                      data-social='<?= json_encode($value) ?>'>
                      <i class="fas fa-pencil-alt text-white"></i>
                    </button>
                    <button
                      href=""
                      class="btn btn-danger border-0 rounded-pill mr-2 btn-sm px-3 deleteItem"
                      rol="admin"
                      table="socials"
                      colum="social"
                      idItem="<?= base64_encode($value->id_social) ?>">
      ...
      <form method="post" class="needs-validation" novalidate>
        ...
        <div class="modal-body bodyMySocial">
          <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="name_social" placeholder="Ej: Facebook" name="name_social" onchange="validateJS(event,'text')" required>
          ...
          <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="url_social" placeholder="Ej: https://facebook.com/" name="url_social" onchange="validateJS(event,'complete')" required>
          ...
          <div class="row">
            ...
            <div class="col">
              <div class="input-group">
                <span class="input-group-text iconView" style="background:<?= $topColor->background ?>;">
                  <i class="fas fa-shopping-bag"></i>
                </span>

                <input type="text" class="form-control" id="icon_social" name="icon_social" onfocus="addIcon(event)" value="fas fa-shopping-bag" required>
