...
<div class="container-fluid bg-white">
  <div class="container">
    ...
    <!-- GRID -->
    <div class="row row-cols-2 row-cols-sm-2 row-cols-md-4 pt-3 pb-4 grid-1">
      <?php foreach ($freeProducts as $key => $value): ?>
        <div class="col px-3 py-2 py-lg-0">
          <a href="/<?= $value->url_product ?>">
            <figure class="imgProduct">
              ...
              <?php else: $arrayYT = explode('/', $value->media_variant) ?>
                <img src="http://img.youtube.com/vi/<?= end($arrayYT) ?>/maxresdefault.jpg" alt="<?= $value->name_product ?>" class="img-fluid bg-light">
              <?php endif ?>
            </figure>
          ...
          <p class="small">
            ...
            <?php if ($diff->days < 30): ?>
              <span class="badge badgeNew bt-warning text-uppercase text-white mt-1 p-2 badge-pill">
                Nuevo
              </span>
            <?php endif ?>
          ...
          <div class="clearfix">
            ...
            <span class="float-end">
              <div class="btn-group btn-group-sm">
                <button type="button" class="btn btn-light border" data-bs-toggle="modal" data-bs-target="#login" idProduct="46" idFavorite="0" pageFavorite="no">
                  <i class="fas fa-heart"></i>
                </button>

                <button type="button" class="btn btn-light border" onclick="location.href='/<?= $value->url_product ?>'">
