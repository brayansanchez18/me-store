    ...
    <div class="container-fluid" style="background-color: rgba(0,0,0,.5);">
      <div class="container text-right p-5">
        <?php if ($banner->text_banner != null): ?>
          <h1 class="text-uppercase" style="color:#fff; text-shadow: 2px 2px 5px #000"><?= $banner->text_banner ?></h1>
        <?php endif ?>

        <?php if ($banner->discount_banner != null): ?>
          <h2 style="color:#fff; text-shadow: 2px 2px 5px #000"><?= $banner->discount_banner ?>% off</h2>
        <?php endif ?>

        <?php if ($banner->end_banner != null): ?>
          <h3 style="color:#fff; text-shadow: 2px 2px 5px #000">Termina el <?= TemplateController::formatDate(1, $banner->end_banner) ?></h3>
        <?php endif ?>
      </div>
    </div>
  </div>
